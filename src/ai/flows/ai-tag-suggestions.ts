 ...
 *
 * - suggestTags - A function that suggests tags for a note.
...
const suggestTagsPrompt = ai.definePrompt({
  ...
  prompt: `You are a helpful assistant that suggests tags for notes based on their content.

  Suggest 3-5 tags that are relevant to the content of the note.
