...
/**
 * @fileOverview This file defines the AI summarization flow for NoteCraft.
 *
 * - summarizeNote - A function that summarizes a note into a 1-2 line summary using AI.
...
const SummarizeNoteOutputSchema = z.object({
  summary: z.string().describe('A 1-2 line summary of the note.'),
});
...
const summarizeNotePrompt = ai.definePrompt({
  ...
  prompt: `Summarize the following note in 1-2 lines:\n\n{{{noteContent}}}`,
});
